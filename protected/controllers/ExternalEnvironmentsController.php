...
class ExternalEnvironmentsController extends Controller
{
	...
	{
		$model = new ExternalEnvironments;
	...
	{
		$model = new ExternalEnvironments('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['ExternalEnvironments']))
			$model->attributes = $_GET['ExternalEnvironments'];
	 ...
	 * @return ExternalEnvironments the loaded model
	 ...
	 * @param ExternalEnvironments $model the model to be validated
	 */
